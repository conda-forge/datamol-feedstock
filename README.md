...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/datamol-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12384&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/datamol-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `datamol` can be installed with:

```
conda install datamol
```

It is possible to list all of the versions of `datamol` available on your platform with:
